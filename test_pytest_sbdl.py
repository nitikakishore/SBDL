...
## validating the spark version
def test_blank_test(spark):
    print(spark.version)
    assert spark.version == "3.5.1"

## matching/validating the kafka topic in LOCAL and the name of hive database in QA
def test_get_config():
...
## validating the number of rows in the read_accounts dataframe ..it should be 8
